  ...
  <div class="">
    <div>
      <Modal
        ...
        @close="closeModal"
      >
        <LivenessVerification @done="getSelfie" @close="closeModal" />
      </Modal>
    </div>
      ...
      <form class="space-y-4">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex-1">
            <label
              for="phone_number"
              class="block mb-2 leading-6 text-grey-500"
            >
              Phone Number
            </label>
            ...
            <el-input
              ...
              type="tel"
              class="input-with-select !tracking-widest bg-input-bg h-[3rem]"
            >
              <template #prepend>
                <div class="flex space-x-1 items-center">
                  ...
                  <p class="text-grey-600 text-sm leading-5">
                    {{ countryPhoneCode }}
                  </p>
                </div>
              </template>
          ...
          <div class="flex-1">
            ...
            <div class="relative bg-input-bg rounded">
              <input
                ...
                placeholder="enter pasport number"
        ...
        <div>
          ...
          <div class="w-3/5 flex items-center space-x-0">
            <el-radio-group
              v-model="kycPayload.power_of_attorney"
              class="!w-full"
            >
...
<script setup lang="ts">
  ...
  const onUploaded = ({ image_url }: any) =>
    (kycPayload.value.international_passport = image_url)

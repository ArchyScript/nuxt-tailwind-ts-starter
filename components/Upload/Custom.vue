...
const uploadInProgress: Ref<any> = ref(false)
const csvFile: Ref<any> = ref(null)
const importUrl: Ref<any> = ref('') 
...
const clearCSV = () => {
  ...
  selectedFile.value.speed = "";
  selectedFile.value.percent =  "";
  selectedFile.value.loaded = "" ;
  selectedFile.value.total =  "";  
}

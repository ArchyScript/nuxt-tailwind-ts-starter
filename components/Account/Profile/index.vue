    ...
    <div class="grid grid-cols-3 gap-x-8">
      <section class="col-span-2 space-y-6 items-center mb-16">
        <CardContainer class="!p-5 rounded-md !pr-8 space-y-4 w-full">
            ...
            <!-- <div v-if="activeTabId == 'rep_details'"> test </div> -->
            <AccountProfileRepDetails  v-if="activeTabId == 'rep_details'" :details="authUser.value?.kyc"/>
            <AccountProfileCompanyDetails  v-else :details="authUser.value?.kyc"/>
        </CardContainer>
        ...
        <CardContainer class="!p-5 rounded-md space-y-3 w-full">
          ...
          <div class="flex items-center rounded-md space-x-6">
            ...
            <div class="flex-1 space-y-4">
              <h6 class="text-sm font-medium text-grey-500 !leading-[160%] flex-1">
                Edit company`s logo
              </h6>

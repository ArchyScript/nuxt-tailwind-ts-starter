<template>    
    <div class="space-y-4">
        ...
        <form class="mt-8 grid grid-cols-2 gap-4" @submit.prevent="updateKYCDetails">
            ...
            <label class="text-grey-500 leading-[160%] text-sm" for="address">Address</label>
            ...
            <div class="flex-col space-y-2">
            <label class="text-grey-500 leading-[160%] text-sm" for="email">Email</label>
            ...
            <div class="flex-col space-y-2">
            <label class="text-grey-500 leading-[160%] text-sm" for="title">Title</label>

<template> 
    <div class="space-y-4">
        ...
        <form class="mt-8 grid grid-cols-2 gap-4" @submit.prevent="updateKYCDetails">
            ...
            <div class="flex-col space-y-2">
            <label class="text-grey-500 leading-[160%] text-sm" for="company_reg_number">
            ...
            <label class="text-grey-500 leading-[160%] text-sm" for="company_address">
            ...
            <label
                ...
                for="company_financial_intermediary"
            >
            ...
            <div class="w-3/5 flex items-center space-x-0">
                <el-radio-group
                v-model="payload.company_financial_intermediary"
                class="!w-full"
                >
            ...
            <label
                class="text-grey-500 leading-[160%] text-sm"
                for="investigated_for_money_laundering"
            >
            ...
            <div class="w-3/5 flex items-center space-x-0">
                <el-radio-group
                v-model="payload.investigated_for_money_laundering"
                class="!w-full"
                >
                <el-radio label="yes" border class="flex-1 !h-[3rem] !px-4">Yes</el-radio>
                <el-radio label="no" border class="flex-1 !h-[3rem] !px-4">No</el-radio>
...
<script setup lang="ts">
  ...
  const populatePayload = async () => { 
    ...
    payload.value.company_financial_intermediary = company_financial_intermediary;
    payload.value.aml_appropriate_regulation = aml_appropriate_regulation;
    payload.value.appropriate_prudential_supervision = appropriate_prudential_supervision;
    payload.value.investigated_for_money_laundering = investigated_for_money_laundering; 
  };

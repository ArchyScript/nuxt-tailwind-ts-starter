      ...
      <div class="text-sm p-1 space-y-8">
        <div class="flex-col space-y-8">
          <p class="text-center text-grey-400 leading-6">
            ...
            kindly complete KYC information below to enable you Fund offers on
            our marketplace.
          </p>
...
<script setup lang="ts">
  ...
  const getCountryCode = (selectedCountry: any, user: string) => {
    ...
    if (user == "company")
      companyCountryISO2.value = selectedCountry.iso2.toLowerCase()
  }
